...
class SpanBasedModel2(chainer.Chain):
    """
    SpanBasedModel w/o any template features
    """
    ...
    def __init__(self,
        ...
        # MLPs
        links["W1_bkt"] = L.Linear(self.bilstm_dim, self.mlp_dim)
        links["W2_bkt"] = L.Linear(self.mlp_dim, 1)
        super(SpanBasedModel2, self).__init__(**links)
    ...
    def compute_span_vectors(
        ...
        :rtype: Variable(shape=(batch_size * n_spans, bilstm_dim), dtype=np.float32)
        """
    ...
    def forward_spans_for_bracketing(
        ...
        span_vectors = self.compute_span_vectors(
                                            ...
                                            mask_bwd=mask_bwd,
                                            mask_fwd=mask_fwd,
                                            batch_spans=batch_spans) # (total_spans, bilstm_dim)
